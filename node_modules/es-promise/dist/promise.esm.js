...
if (typeof Promise$1.try !== 'function') {
  Promise$1.try = {
...
if (typeof Promise$1.prototype.finally !== 'function') {
  ...
  var shim = {
      ...
      var C;
      var newPromise = Promise$1.prototype.then.call(this, // throw if IsPromise(this) is not true
      function (x) {
      ...
      C = speciesConstructor(this, Promise$1); // throws if SpeciesConstructor throws
      return newPromise;
    }
  };
  Object.defineProperty(Promise$1.prototype, 'finally', { configurable: true, writable: true, value: shim.finally }); /* eslint no-extend-native: "off" */
}
